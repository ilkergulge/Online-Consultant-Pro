...
<head>
    <style>
        ...
        .header { background-color: #f8fafc; padding: 10px 20px; text-align: center; border-bottom: 2px solid #3b82f6; }
        .content { padding: 20px 0; }
        .btn { display: inline-block; padding: 10px 20px; background-color: #3b82f6; color: #ffffff; text-decoration: none; border-radius: 5px; font-weight: bold; }
...
<body>
    <div class="container">
        <div class="header">
            <h2>{{ __('frontend.appointment_confirmed_subject') }}</h2>
        </div>
        <div class="content">
            <p>{{ __('frontend.hello') }}, {{ $appointment->client->name }}!</p>
            <p>{{ __('frontend.appointment_confirmed_message') }}</p>
